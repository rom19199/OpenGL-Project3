...
craft = Model('craft.obj', 'craftT2.bmp')
craft.scale = glm.vec3(0.3,0.3,0.3)
craft.rotation = glm.vec3(0,90,0)
renderer.modelList.append(craft)

airC = Model('E 45 Aircraft_obj.obj', 'E45T.bmp')
airC.scale = glm.vec3(0.3,0.3,0.3)
renderer.modelList.append(airC)
